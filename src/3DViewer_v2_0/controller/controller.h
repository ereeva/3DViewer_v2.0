...
class Controller {
 public:
  ...
  void RotateObjectX(double angle) { obj_->RotateX(angle); }
  void RotateObjectY(double angle) { obj_->RotateY(angle); }
  void RotateObjectZ(double angle) { obj_->RotateZ(angle); }

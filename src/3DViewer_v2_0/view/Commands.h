...
namespace s21 {
  class SetPointSizeCommand : public ICommand {
   ...
   public:
    ...
    void execute() override {
      ui_->widget->pointSize = newValue_;
    }

    void undo() override {
      ui_->widget->pointSize = oldValue_;
    }
  };
  ...
  class SetLineSizeCommand : public ICommand {
   ...
   public:
    ...
    void execute() override {
      ui_->widget->lineSize = newValue_;
    }

    void undo() override {
      ui_->widget->lineSize = oldValue_;
    }
  };
  ...
  class SetLineTypeCommand : public ICommand {
   ...
   public:
    ...
    void execute() override {
      ui_->widget->lineType = newValue_;
    }

    void undo() override {
      ui_->widget->lineType = oldValue_;
    }
  };
  ...
  class SetPerspectiveCommand : public ICommand {
   ...
   public:
    ...
    void execute() override {
      ui_->widget->perspective = newValue_;
    }

    void undo() override {
      ui_->widget->perspective = oldValue_;
    }
  };
  ...
  class SetPointTypeCommand : public ICommand {
   ...
   public:
    ...
    void execute() override {
      ui_->widget->pointType = newValue_;
    }

    void undo() override {
      ui_->widget->pointType = oldValue_;
    }
  };
  ...
  class SetLineColorCommand : public ICommand {
   ...
   public:
    ...
    void execute() override {
      ui_->widget->lineColor = newValue_;
    }

    void undo() override {
      ui_->widget->lineColor = oldValue_;
    }
  };
  ...
  class SetPointColorCommand : public ICommand {
   ...
   public:
    ...
    void execute() override {
      ui_->widget->pointColor = newValue_;
    }

    void undo() override {
      ui_->widget->pointColor = oldValue_;
    }
  };
  ...
  class SetBackgroundColorCommand : public ICommand {
   ...
   public:
    ...
    void execute() override {
      ui_->widget->backgroundColor = newValue_;
    }

    void undo() override {
      ui_->widget->backgroundColor = oldValue_;
    }
  };
